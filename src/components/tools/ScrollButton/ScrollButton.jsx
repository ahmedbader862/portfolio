...
function ScrollButton() {
    const scrollToNextSection = useCallback(() => {
        // استخدام window.scrollY العادي بدلاً من scrollY من context
    ...
    return (
        ...
        <div className="circle-btn-wrap">
            ...
            >
                <svg className="w-[48px] h-[48px] text-gray-100 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
